      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="text-success fas fa-fw fa-caret-up"></i> <i class="text-success fas fa-fw fa-dollar-sign"></i> KASmart</h5>
                <h6 class="text-muted">Jumlah KASmart: Rp. <?= number_format($jml_uang_kas - $jml_pengeluaran); ?></h6>
