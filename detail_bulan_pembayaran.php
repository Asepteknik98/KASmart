              ...
              <?php foreach ($uang_kas as $duk): ?>
                <?php 
                  ...
                  if ($id_bulan_pembayaran != $id_bulan_pembayaran_pertama) {
                    ...
                    if ($data_bulan_sebelum && isset($data_bulan_sebelum['minggu_ke_4']) && $data_bulan_sebelum['minggu_ke_4']) {
                ...
                <?php else: ?>
                  <?php if ($id_bulan_pembayaran != $id_bulan_pembayaran_pertama AND $data_bulan_sebelum && isset($data_bulan_sebelum['status_lunas']) && $data_bulan_sebelum['status_lunas'] == '0'): ?>
                    <tr class="bg-danger">
                  <?php else: ?>
                    <tr>
                  <?php endif ?>
                  ...
                  <div class="modal fade" id="editMingguKe1<?= $duk['id_uang_kas']; ?>" tabindex="-1" role="dialog" aria-labelledby="editMingguKe1Label<?= $dbp['id_bulan_pembayaran']; ?>" aria-hidden="true">
