...
<div class="wrapper">
        			...
        			<div class="form-group">
	        			...
	        			<select name="id_bulan_pembayaran" id="id_bulan_pembayaran" class="form-control">
	        				<?php if (isset($_POST['btnLaporanPemasukkan'])): ?>
	        					<option value="<?= $fetch_sql['id_bulan_pembayaran']; ?>"><?= isset($fetch_sql['nama_bulan']) ? ucwords($fetch_sql['nama_bulan']) : '' ?> | <?= isset($fetch_sql['tahun']) ? $fetch_sql['tahun'] : '' ?> | Rp. <?= isset($fetch_sql['pembayaran_perminggu']) ? number_format($fetch_sql['pembayaran_perminggu']) : '0' ?></option>
        ...
        <?php if (isset($_POST['btnLaporanPemasukkan'])): ?>
        	...
        	<div class="row m-1">
	        	<div class="col-lg m-1">
	        		...
	        		<h3 class="text-left mb-3">Laporan Pada Bulan: <?= isset($fetch_sql['nama_bulan']) ? ucwords($fetch_sql['nama_bulan']) : '' ?>, Tahun: <?= isset($fetch_sql['tahun']) ? $fetch_sql['tahun'] : '' ?>, Pembayaran Perminggu: Rp. <?= isset($fetch_sql['pembayaran_perminggu']) ? number_format($fetch_sql['pembayaran_perminggu']) : '0' ?></h3>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025 By Multimedia Kreatif SMK JAYA BUANA.</strong>
    All rights reserved.
